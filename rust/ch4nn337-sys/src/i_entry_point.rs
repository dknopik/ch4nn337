...
pub mod i_entry_point {
    ...
    impl<M> ::core::fmt::Debug for IEntryPoint<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IEntryPoint)).field(&self.address()).finish()
        }
    }
